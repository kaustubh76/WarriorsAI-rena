/**
 * Arena Hooks Index
 * Export all prediction arena related hooks
 */

export { usePredictionBattles, usePredictionBattle } from './usePredictionBattles';
export { usePredictionArena } from './usePredictionArena';
...
export { useAutoExecuteBattle, type AutoExecutePhase } from './useAutoExecuteBattle';
