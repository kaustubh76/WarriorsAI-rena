...
const WarriorsMinterPage = memo(function WarriorsMinterPage() {
      ...
      reader.onload = (event) => {
        ...
        img.onload = () => {
          ...
          if (img.width === img.height) {
            ...
            setFormData((prev: FormData) => ({ ...prev, image: file }));
  ...
  const generatePersonality = async () => {
    ...
    showMessage({
      ...
      text: "Initializing 0G AI strategy analysis... Extracting DeFi trading signals from your life story. This may take a moment...",
      duration: 5000
    });
    ...
    try {
      ...
      try {
        const parsedResponse = JSON.parse(cleanAIJson(response));
        
        // Map the AI response to form fields
        const name = parsedResponse.name || 'AI Generated Strategy';
        ...
        setFormData({
          ...
          life_history: 'Generated by 0G AI based on your life story',
          adjectives: 'Adaptive, AI-crafted, Autonomous',
          knowledge_areas: 'DeFi strategies based on your description',
          image: formData.image
        });
      }
  ...
  const handleMintWarriorsNFT = async () => {
    ...
    showMessage({
      id: 'minting_start',
      text: "Deploying your DeFi strategy NFT to Flow blockchain! Your autonomous trading identity is being forged...",
      duration: 6000
    });
  ...
  const handlePromoteWarriors = async (warriors: UserWarriors) => {
    try {
      showMessage({
        id: 'promotion_start',
        text: `Evaluating ${warriors.name}'s performance metrics for tier promotion...`,
        duration: 5000
      });
      ...
      showMessage({
        ...
        text: `${warriors.name} promoted from ${warriors.rank} to ${getNextRank(warriors.rank)}! Strategy tier upgraded on-chain.`,
        duration: 7000
      });
  ...
  const handleActivateWarriors = async (warriors: UserWarriors) => {
    ...
    let contractCallInitiated = false;

    // Trigger warrior message for activation start
    showMessage({
      id: 'activation_start',
      text: `Activating ${warriors.name}... 0G AI is analyzing traits and generating DeFi strategy actions.`,
      duration: 5000
    });
    ...
    try {
      ...
      if (!apiResponse.ok) {
        const errData = await apiResponse.json().catch(() => ({}));
        throw new Error(errData.error || `API request failed (${apiResponse.status})`);
      }
      const apiData = await apiResponse.json();
      ...
      // Validate and clamp trait values to valid range
      const traitNames = ['Strength', 'Wit', 'Charisma', 'Defence', 'Luck'] as const;
      for (const trait of traitNames) {
        const value = parsedResponse[trait];
        if (typeof value !== 'number' || value < 0 || value > 10000) {
          console.warn(`Clamping ${trait} from ${value} to valid range`);
          parsedResponse[trait] = Math.max(0, Math.min(10000, Number(value) || 5000));
        }
      }
      ...
      console.log("Requesting Game Master signature from server...");
      ...
      console.log("Game Master signature obtained");
      ...
      // Only keep isActivating=true if a contract call was initiated (awaiting tx confirmation)
      if (!contractCallInitiated) {
        setIsActivating(false);
      }
    }
  };
  ...
  const WarriorsCard = memo(({ warriors, onClick }: { warriors: UserWarriors; onClick: () => void }) => {
    ...
    return (
      ...
      <div className="space-y-2 mb-4">
        <TraitBar label="ALPHA" value={warriors.traits.strength} />
        <TraitBar label="COMPLX" value={warriors.traits.wit} />
        <TraitBar label="MOMEN" value={warriors.traits.charisma} />
        <TraitBar label="HEDGE" value={warriors.traits.defence} />
        <TraitBar label="TIMING" value={warriors.traits.luck} />
      </div>
  ...
  const handleCropComplete = useCallback(async () => {
    if (completedCrop && imgRef.current && cropImageSrc) {
      try {
        ...
        setFormData((prev: FormData) => ({ ...prev, image: croppedFile }));
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            >
              FORGE YOUR AI DEFI STRATEGY NFTs
            </p>
          </div>
        </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Describe your life story, career, and personality..."
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Brief strategy thesis..."
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Your life story and trading philosophy..."
                  ...
                  <div className="border-2 border-dashed border-gray-600 p-4 text-center hover:border-yellow-600 transition-colors relative rounded-2xl">
                    {imagePreview ? (
                      <div className="space-y-2">
                        ...
                        <button
                          onClick={() => {setImagePreview(null); setFormData((prev: FormData) => ({...prev, image: null}))}}
                  ...
                  {ipfsCid && (
                    <div className="mt-4 p-3 bg-green-900/30 border border-green-500 rounded-lg">
                      <p className="text-green-400 text-xs mb-2" style={{fontFamily: 'Press Start 2P, monospace'}}>
                        STRATEGY NFT METADATA UPLOADED TO 0G STORAGE
                      </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {isLoadingNFTs ? (
                ...
                userNFTs.map((warriors: UserWarriors) => (
                  <WarriorsCard
                    key={warriors.id}
                    warriors={warriors}
                ...
                <div className="col-span-full text-center py-12">
                  <p 
                    ...
                    style={{fontFamily: 'Press Start 2P, monospace'}}
                  >
                    NO STRATEGIES FOUND. CREATE YOUR FIRST STRATEGY NFT!
                  </p>
                  <button
                    onClick={() => setActiveSection('create')}
                    className="mt-4 px-6 py-3 arcade-button text-xs tracking-wide"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-4 mb-8">
                    <TraitBar label="ALPHA" value={selectedWarriors.traits.strength} />
                    <TraitBar label="COMPLEXITY" value={selectedWarriors.traits.wit} />
                    <TraitBar label="MOMENTUM" value={selectedWarriors.traits.charisma} />
                    <TraitBar label="HEDGE" value={selectedWarriors.traits.defence} />
                    <TraitBar label="TIMING" value={selectedWarriors.traits.luck} />
                  </div>
                  ...
                  <div className="border-t border-orange-600 pt-6">
                    ...
                    {!isWarriorsInactive(selectedWarriors.traits) && selectedWarriors.rank !== 'platinum' ? (
                      <div>
                        ...
                        >
                          {canPromote(selectedWarriors) ? 'PROMOTE STRATEGY' : 'INSUFFICIENT WINNINGS'}
                        </button>
                      </div>
                    ) : !isWarriorsInactive(selectedWarriors.traits) && selectedWarriors.rank === 'platinum' ? (
            ...
            >
              <div className="text-center mb-8">
                ...
                <p 
                  ...
                  style={{fontFamily: 'Press Start 2P, monospace'}}
                >
                  GET AI ADVICE FOR YOUR STRATEGIES
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <textarea
                    value={aiPrompt}
                    onChange={(e) => setAiPrompt(e.target.value)}
                    placeholder="What traits should I prioritize for my next strategy? How can I optimize my DeFi approach?"
                ...
                >
                  ...
                  >
                    {aiPrompt ? 
                      "The AI Strategy Advisor will provide guidance on strategy creation, trait optimization, and DeFi approach tuning. Ask specific questions about your strategy development!" :
                      "Enter your question above to receive AI-powered DeFi strategy insights..."
                    }
                  </p>
                </div>
              </div>
